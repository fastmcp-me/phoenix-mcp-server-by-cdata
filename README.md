[![Add to Cursor](https://fastmcp.me/badges/cursor_dark.svg)](https://fastmcp.me/MCP/Details/1756/phoenix-mcp-server-by-cdata)
[![Add to VS Code](https://fastmcp.me/badges/vscode_dark.svg)](https://fastmcp.me/MCP/Details/1756/phoenix-mcp-server-by-cdata)
[![Add to Claude](https://fastmcp.me/badges/claude_dark.svg)](https://fastmcp.me/MCP/Details/1756/phoenix-mcp-server-by-cdata)
[![Add to ChatGPT](https://fastmcp.me/badges/chatgpt_dark.svg)](https://fastmcp.me/MCP/Details/1756/phoenix-mcp-server-by-cdata)
[![Add to Codex](https://fastmcp.me/badges/codex_dark.svg)](https://fastmcp.me/MCP/Details/1756/phoenix-mcp-server-by-cdata)
[![Add to Gemini](https://fastmcp.me/badges/gemini_dark.svg)](https://fastmcp.me/MCP/Details/1756/phoenix-mcp-server-by-cdata)

# phoenix-mcp-server-by-cdata
CData's Model Context Protocol (MCP) Server for Phoenix

:heavy_exclamation_mark: This project builds a read-only MCP server. For full read, write, update, delete, and action capabilities and a simplified setup, check out our [CData MCP Server for Phoenix](https://www.cdata.com/drivers/phoenix/download/mcp/). 
## Purpose
